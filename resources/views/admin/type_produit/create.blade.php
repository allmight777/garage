...
@section('content')
    ...
    <div class="admin-container">
        ...
        <div class="form-card animate-fade-in">
            ...
            <form action="{{ route('type_produits.store') }}" method="POST" enctype="multipart/form-data" id="typeForm"
                class="form-content">
                @csrf
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" id="nom" name="nom" class="form-input"
                                    placeholder="Ex: Pneus Sport" required maxlength="100">
                            </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.querySelectorAll('.btn-prev, .btn-next, .btn-submit, .btn-upload, .btn-remove').forEach(
                btn => {
