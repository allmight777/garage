...
<style>
    ...
    .gradient-submit { background: var(--gradient-submit); }
...
<div class="admin-container">
    ...
    <div class="main-card animate-fade-in glass-effect">
        <form action="{{ route('produits.update', $produit) }}" method="POST" enctype="multipart/form-data" id="productForm">
            @csrf
            @method('PUT')
                        ...
                        <div class="preview-content">
                            ...
                            <div class="current-info">
                                ...
                                <div class="info-item">
                                    ...
                                    <span class="info-value price-value">{{ number_format($produit->prix_vente, 2) }} FCFA</span>
                                </div>
                                <div class="info-item">
                                    <span class="info-label">Marge actuelle</span>
                                    <span class="info-value marge-value @if($produit->marge > 0) text-profit @else text-loss @endif">
                                        {{ number_format($produit->marge, 2) }} FCFA
                                        <span class="marge-percent">({{ number_format($produit->marge / $produit->prix_achat * 100, 1) }}%)</span>
                                    </span>
                                </div>
                            </div>
                        </div>
                ...
                <div class="form-section glass-effect" id="step-1">
                    ...
                    <div class="form-group">
                        ...
                        <div class="select-wrapper">
                            <select id="type_produit_id"
                                    name="type_produit_id"
                                    class="form-select @error('type_produit_id') error @enderror">
                                <option value="">Sélectionner un type</option>
                                @foreach($types as $type)
                                <option value="{{ $type->id }}" {{ old('type_produit_id', $produit->type_produit_id) == $type->id ? 'selected' : '' }}>
                                    {{ $type->nom }}
                                </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-hint">
                            ...
                            <a href="{{ route('type_produits.create') }}" class="add-type-link">Créer un nouveau type</a>
                        </div>
                    </div>
                            ...
                            <div class="input-with-validation">
                                <div class="input-group">
                                    ...
                                    <input type="number"
                                           ...
                                           id="prix_achat"
                                           name="prix_achat"
                                           class="form-input @error('prix_achat') error @enderror"
                            ...
                            <div class="input-with-validation">
                                <div class="input-group">
                                    ...
                                    <input type="number"
                                           ...
                                           id="prix_vente"
                                           name="prix_vente"
                                           class="form-input @error('prix_vente') error @enderror"
                            ...
                            <div class="margin-bar">
                                <div class="margin-fill" id="margeBar"
                                     style="width: {{ min(($produit->marge / $produit->prix_achat * 100), 100) }}%;
                                            @if(($produit->marge / $produit->prix_achat * 100) >= 50)
                            ...
                            <div class="input-with-validation">
                                <div class="input-group">
                                    <input type="number"
                                           ...
                                           name="taux_tva"
                                           class="form-input"
                                           value="{{ old('taux_tva', $produit->taux_tva) }}"
                                           placeholder="20.00">
                        ...
                        <div class="form-group">
                            ...
                            <div class="select-wrapper">
                                <select id="unite_mesure" name="unite_mesure" class="form-select">
                                    <option value="unité" {{ old('unite_mesure', $produit->unite_mesure) == 'unité' ? 'selected' : '' }}>Unité</option>
                                    <option value="kg" {{ old('unite_mesure', $produit->unite_mesure) == 'kg' ? 'selected' : '' }}>Kilogramme</option>
                                    <option value="g" {{ old('unite_mesure', $produit->unite_mesure) == 'g' ? 'selected' : '' }}>Gramme</option>
                                    <option value="L" {{ old('unite_mesure', $produit->unite_mesure) == 'L' ? 'selected' : '' }}>Litre</option>
                                    <option value="mL" {{ old('unite_mesure', $produit->unite_mesure) == 'mL' ? 'selected' : '' }}>Millilitre</option>
                                    <option value="m" {{ old('unite_mesure', $produit->unite_mesure) == 'm' ? 'selected' : '' }}>Mètre</option>
                                    <option value="cm" {{ old('unite_mesure', $produit->unite_mesure) == 'cm' ? 'selected' : '' }}>Centimètre</option>
                                    <option value="paquet" {{ old('unite_mesure', $produit->unite_mesure) == 'paquet' ? 'selected' : '' }}>Paquet</option>
                                    <option value="carton" {{ old('unite_mesure', $produit->unite_mesure) == 'carton' ? 'selected' : '' }}>Carton</option>
                                </select>
                                <div class="select-arrow">
                                    <i class="fas fa-chevron-down"></i>
                                </div>
                            ...
                            <div class="image-upload glass-effect" id="imageUpload">
                                ...
                                <div class="upload-preview" id="uploadPreview">
                                    ...
                                    <div class="image-preview">
                                        <img src="{{ asset('storage/produits/'.$produit->image) }}" alt="Aperçu">
                                    </div>
                                ...
                                <div class="upload-actions">
                                    ...
                                    @if($produit->image)
                                    <button type="button" class="btn-remove" id="removeImage" onclick="removeCurrentImage()">
                    ...
                    <div class="form-preview glass-effect">
                        ...
                        <div class="preview-content">
                            ...
                            <div class="preview-item">
                                ...
                                <span class="preview-value" id="previewReference"> &nbsp;  {{ $produit->reference }}</span>
                            </div>
                            <div class="preview-item">
                                <span class="preview-label"> Nouveau prix</span>
                                <span class="preview-value" id="previewPrix"> &nbsp; {{ number_format($produit->prix_vente, 2) }} FCFA</span>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function setupFormValidation() {
            ...
            prixAchatInput.addEventListener('change', function() {
                ...
                if (prixAchat > 0 && (!prixVenteInput.value || parseFloat(prixVenteInput.value) <= prixAchat)) {
