                    ...
                    <div class="form-group">
                        ...
                        <div class="select-wrapper">
                            <select id="type_produit_id"
                                ...
                                <option value="{{ $type->id }}" {{ old('type_produit_id') == $type->id ? 'selected' : '' }}>
                                    {{ $type->nom }}
                                </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-with-validation">
                                <input type="text"
                                       ...
                                       class="form-input"
                                       value="{{ old('marque') }}"
                                       placeholder="Ex: Avon, Pneu Express CI">
                                <div class="input-icons">
                                    <i class="fas fa-check-circle valid-icon"></i>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-with-validation">
                                <input type="text"
                                       ...
                                       class="form-input"
                                       value="{{ old('modele') }}"
                                       placeholder="Ex: Energy Saver + , Dueler H/L 33">
                                <div class="input-icons">
                                    <i class="fas fa-check-circle valid-icon"></i>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="select-wrapper">
                                <select id="unite_mesure" name="unite_mesure" class="form-select">
                                    <option value="unité" {{ old('unite_mesure') == 'unité' ? 'selected' : '' }}>Unité</option>
                                    <option value="kg" {{ old('unite_mesure') == 'kg' ? 'selected' : '' }}>Kilogramme</option>
                                    <option value="g" {{ old('unite_mesure') == 'g' ? 'selected' : '' }}>Gramme</option>
                                    <option value="L" {{ old('unite_mesure') == 'L' ? 'selected' : '' }}>Litre</option>
                                    <option value="mL" {{ old('unite_mesure') == 'mL' ? 'selected' : '' }}>Millilitre</option>
                                    <option value="m" {{ old('unite_mesure') == 'm' ? 'selected' : '' }}>Mètre</option>
                                    <option value="cm" {{ old('unite_mesure') == 'cm' ? 'selected' : '' }}>Centimètre</option>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function updatePreview() {
            ...
            previewPrix.textContent = (prixVenteInput.value ? `${parseFloat(prixVenteInput.value).toFixed(2)} FCFA` : '-');
        }
