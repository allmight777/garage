    ...
    <div class="admin-container">
        <div class="admin-header">
            <div class="header-content animate-slide-down">
                ...
                <p class="admin-subtitle">Créez un nouveau produit dans votre catalogue</p>
            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-with-validation">
                                    <input type="text" id="reference" name="reference"
                                        ...
                                        value="{{ old('reference') }}" required placeholder="PROD-001">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-with-validation">
                                    <input type="text" id="nom" name="nom"
                                        class="form-input @error('nom') error @enderror" value="{{ old('nom') }}"
                                        required placeholder="Ex: Pneus XYW">
                                    <div class="input-icons">
                                        <i class="fas fa-check-circle valid-icon"></i>
                                        <i class="fas fa-exclamation-circle error-icon"></i>
                                    </div>
                                ...
                                <select id="type_produit_id" name="type_produit_id"
                                    ...
                                    @foreach ($types as $type)
                                        <option value="{{ $type->id }}"
                                            {{ old('type_produit_id') == $type->id ? 'selected' : '' }}>
                                            {{ $type->nom }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-with-validation">
                                    <input type="text" id="marque" name="marque" class="form-input"
                                        value="{{ old('marque') }}" placeholder="Ex: Avon, Pneu Express CI">
                                    <div class="input-icons">
                                        <i class="fas fa-check-circle valid-icon"></i>
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-with-validation">
                                    <input type="text" id="modele" name="modele" class="form-input"
                                        value="{{ old('modele') }}" placeholder="Ex: Energy Saver + , Dueler H/L 33">
                                    <div class="input-icons">
                                        <i class="fas fa-check-circle valid-icon"></i>
                                    </div>
                                </div>
                                ...
                                <div class="input-with-validation">
                                    <div class="input-group">
                                        ...
                                        <input type="number" step="0.01" min="0" id="prix_achat"
                                            ...
                                            value="{{ old('prix_achat', 0) }}" required placeholder="0.00">
                                    </div>
                                    <div class="input-icons">
                                        <i class="fas fa-check-circle valid-icon"></i>
                                        <i class="fas fa-exclamation-circle error-icon"></i>
                                ...
                                <div class="input-with-validation">
                                    <div class="input-group">
                                        ...
                                        <input type="number" step="0.01" min="0" id="prix_vente"
                                            ...
                                            value="{{ old('prix_vente', 0) }}" required placeholder="0.00">
                                    </div>
                                    <div class="input-icons">
                                        <i class="fas fa-check-circle valid-icon"></i>
                                        <i class="fas fa-exclamation-circle error-icon"></i>
                        ...
                        <div class="margin-calculator glass-effect">
                            ...
                            <div class="calculator-content">
                                <div class="margin-item">
                                    ...
                                    <span class="margin-value" id="margeBrute">0.00 FCFA</span>
                                </div>
                                <div class="margin-item">
                                    <span class="margin-label">Pourcentage de marge</span>
                                    <span class="margin-value" id="margePourcentage">0FCFA</span>
                                </div>
                                <div class="margin-bar">
                                    <div class="margin-fill" id="margeBar"></div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-with-validation">
                                    <input type="number" min="0" id="stock_actuel" name="stock_actuel"
                                        ...
                                        value="{{ old('stock_actuel', 0) }}" required placeholder="0">
                                    <div class="input-icons">
                                        <i class="fas fa-check-circle valid-icon"></i>
                                        <i class="fas fa-exclamation-circle error-icon"></i>
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-with-validation">
                                    <input type="number" min="0" id="seuil_alerte" name="seuil_alerte"
                                        ...
                                        value="{{ old('seuil_alerte', 10) }}" required placeholder="10">
                                    <div class="input-icons">
                                        <i class="fas fa-check-circle valid-icon"></i>
                                        <i class="fas fa-exclamation-circle error-icon"></i>
                                    </div>
                                ...
                                <div class="input-with-validation">
                                    <div class="input-group">
                                        <input type="number" step="0.01" min="0" max="100"
                                            ...
                                            value="{{ old('taux_tva', 20) }}" placeholder="20.00">
                            ...
                            <div class="form-group">
                                ...
                                <div class="select-wrapper">
                                    <select id="unite_mesure" name="unite_mesure" class="form-select">
                                        <option value="unité" {{ old('unite_mesure') == 'unité' ? 'selected' : '' }}>
                                            Unité</option>
                                        <option value="kg" {{ old('unite_mesure') == 'kg' ? 'selected' : '' }}>
                                            Kilogramme</option>
                                        <option value="g" {{ old('unite_mesure') == 'g' ? 'selected' : '' }}>Gramme
                                        </option>
                                        <option value="L" {{ old('unite_mesure') == 'L' ? 'selected' : '' }}>Litre
                                        </option>
                                        <option value="mL" {{ old('unite_mesure') == 'mL' ? 'selected' : '' }}>
                                            Millilitre</option>
                                        <option value="m" {{ old('unite_mesure') == 'm' ? 'selected' : '' }}>Mètre
                                        </option>
                                        <option value="cm" {{ old('unite_mesure') == 'cm' ? 'selected' : '' }}>
                                            Centimètre</option>
                                        <option value="paquet" {{ old('unite_mesure') == 'paquet' ? 'selected' : '' }}>
                                            Paquet</option>
                                        <option value="carton" {{ old('unite_mesure') == 'carton' ? 'selected' : '' }}>
                                            Carton</option>
                                    </select>
                                    <div class="select-arrow">
                                        <i class="fas fa-chevron-down"></i>
                        ...
                        <div class="form-group">
                            ...
                            <div class="textarea-wrapper">
                                <textarea id="description" name="description" class="form-textarea @error('description') error @enderror"
                                    rows="6" placeholder="Décrivez votre produit en détail...">{{ old('description') }}</textarea>
                        ...
                        <div class="form-preview glass-effect">
                            ...
                            <div class="preview-content">
                                <div class="preview-item">
                                    ...
                                    <span class="preview-value" id="previewNom">-</span>
                                </div>
                                <div class="preview-item">
                                ...
                                <div class="preview-item">
                                    <span class="preview-label">Prix vente</span>
                                    <span class="preview-value" id="previewPrix">- FCFA</span>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function updatePreview() {
                ...
                previewPrix.textContent = (prixVenteInput.value ?
                    `${parseFloat(prixVenteInput.value).toFixed(2)} FCFA` : '-');
            }
            ...
            function setupFormValidation() {
                ...
                prixVenteInput.addEventListener('input', updatePreview);
            ...
            function calculateMargin() {
                ...
                if (prixAchat > 0 && prixVente > 0) {
                    ...
                    margeBrute.textContent = `${marge.toFixed(2)} FCFA`;
            ...
            function setupImageUpload() {
                ...
                `;
                    ...
                    setupImageUpload(); // Re-setup les événements
                });
