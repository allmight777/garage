...
<body>
    ...
    <div class="stat-item" style="display: flex; align-items: center; gap: 10px; padding: 10px 15px; border-radius: 8px; background-color: #d60d0d; transition: background 0.2s;">
