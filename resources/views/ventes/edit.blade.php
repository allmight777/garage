                                        ...
                                        <tr class="table-row" data-index="{{ $loop->index }}">
                                            <td data-label="Produit">
                                                <div class="produit-info">
                                                    ...
                                                    <input type="hidden" name="produits[{{ $loop->index }}][ligne_id]"
                                                        value="{{ $ligne->id }}">
                                                    <input type="hidden" name="produits[{{ $loop->index }}][id]"
                                            ...
                                            <td data-label="Quantité">
                                                <div class="qty-control">
                                                    <button type="button" class="btn-qty btn-decrement"
                                                        onclick="modifierQty(this, -1)">-</button>
                                                    <input type="number" name="produits[{{ $loop->index }}][quantite]"
                                                        value="{{ $ligne->quantite }}" class="qty-input" min="1"
                                                        max="{{ $ligne->produit->stock_actuel + $ligne->quantite }}"
                                                        onchange="calculerTotal()">
                                                    <button type="button" class="btn-qty btn-increment"
                                                        onclick="modifierQty(this, 1)">+</button>
                                                </div>
                                            </td>
                ...
                <div class="col-lg-4">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <select name="mode_paiement" class="form-control" required>
                                    ...
                                    <option value="mobile_money"
                                        {{ $vente->mode_paiement == 'mobile_money' ? 'selected' : '' }}>
                                        📱 Mobile Money
                                    </option>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="notes" class="form-control" rows="5"
                                    placeholder="Ajouter des notes concernant cette vente...">{{ $vente->notes }}</textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="main-card mb-4 animate-fade-in" style="animation-delay: 0.2s">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="client_adresse" class="form-control" rows="3" placeholder="Adresse complète du client">{{ $vente->client_adresse ?? ($vente->client->adresse ?? '') }}</textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="main-card animate-fade-in" style="animation-delay: 0.3s">
                        <div class="card-body" style="display: flex; gap: 10px;">
                            <button type="submit" id="btn-enregistrer">
                ...
                $.ajax({
                    ...
                    success: function(produits) {
                        ...
                        if (produits.length > 0) {
                            produits.forEach(p => {
                                const stockClass = p.stock_actuel <= 0 ? 'rupture' :
                                    'normal';
                                html += `
