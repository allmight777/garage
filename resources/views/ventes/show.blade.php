...
<style>
    ...
    .badge-especes { background: #28a745; }
    .badge-mobile_money { background: #17a2b8; }
    .badge-carte { background: #007bff; }
    .badge-cheque { background: #6c757d; }
...
<div class="vente-detail-container">
    ...
    <div class="admin-header animate-slide-down">
        <div class="header-content">
            ...
            <p class="admin-subtitle">Transaction {{ $vente->numero_vente }} • {{ $vente->created_at->format('d/m/Y H:i') }}</p>
        </div>
            ...
            <div class="main-card animate-fade-in" style="animation-delay: 0.1s">
                ...
                <div class="client-section">
                    ...
                    <div class="text-center py-4">
                        <div class="client-avatar" style="background: linear-gradient(135deg, var(--gray), #5a6268);">
            ...
            <div class="main-card animate-fade-in" style="animation-delay: 0.2s">
                <div class="card-header">
                    <h2 class="card-title">
                        ...
                        <span style="background: var(--secondary); color: white; padding: 4px 12px; border-radius: 20px; font-size: 0.9rem;">
                                ...
                                <td data-label="Produit">
                                    <div class="produit-info">
                                        <div class="produit-image">
                                            ...
                                            @else
                                            <i class="fas fa-box" style="font-size: 1.5rem; color: white; line-height: 40px; text-align: center; display: block;"></i>
                                            @endif
                                        </div>
                                        <div class="produit-details">
                                            <h4>{{ $ligne->produit->nom }}</h4>
                                            @if($ligne->produit->marque)
                                            <small><i class="fas fa-tag"></i> {{ $ligne->produit->marque }}</small>
                                            @endif
                                        </div>
                                    </div>
                                </td>
...
<form action="{{ route('ventes.annuler', $vente) }}" method="POST" class="d-inline">
    @csrf
    <button type="submit"
            class="btn-action btn-cancel annuler-btn"
