            ...
            <div class="form-group">
                ...
                <div class="password-input-wrapper">
                    <input type="password" id="password" name="password" class="form-input" required
                        autocomplete="new-password" placeholder="••••••••" oninput="checkPasswordStrength(this.value)">
            ...
            <div class="form-group">
                ...
                <div class="password-input-wrapper">
                    <input type="password" id="password_confirmation" name="password_confirmation" class="form-input"
                        required autocomplete="new-password" placeholder="••••••••" oninput="checkPasswordMatch()">
                ...
                <div id="passwordMatch" class="password-strength" style="display: none;">
                    ...
                    <span style="color: var(--success);">Les mots de passe correspondent</span>
                </div>
